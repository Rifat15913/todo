package com.todo.app.utils.helper.notification
...
object NotificationUtils {
    ...
    private fun createNotificationChannel(
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            channel.setSound(
                soundFileUri ?: RingtoneManager.getDefaultUri(
    ...
    fun buildNotification(
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            if (shouldCreateChannel) {
                createNotificationChannel(
                    ...
                    NotificationManager.IMPORTANCE_HIGH, soundFileUri
                )
            }
        }
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.O) {
            builder.setSound(
                soundFileUri ?: RingtoneManager.getDefaultUri(RingtoneManager.TYPE_NOTIFICATION)
            )
        }
