...
import com.todo.app.main.ui.base.component.BaseItemDetailsLookup
import com.todo.app.main.ui.base.component.BaseSelectableAdapter
import com.todo.app.main.ui.base.helper.SwipeItemHandler
import com.todo.app.main.ui.base.widget.BaseRecyclerView
...
class ViewUtils {
    companion object {
        ...
        fun <T> initializeRecyclerView(
            ...
            if (recyclerView is BaseRecyclerView && emptyPlaceholder != null) {
                recyclerView.setEmptyPlaceholder(emptyPlaceholder)
            }
