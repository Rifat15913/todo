...
import com.todo.app.main.ui.base.helper.SwipeItemHandler.BackgroundMaterial.ICON
        ...
        val foreground: Drawable? =
                if (mBackgroundMaterial == ICON) {
                    ...
                    TextDrawable.builder()
                            .beginConfig()
                        .fontSize(ViewUtils.getResources().getDimensionPixelSize(R.dimen.textBody))
